<form action="/nodes4/{{ $selectedNode->id }}" method="post">
	...
	<div class="mb-3 form-floating">
		...
		<label>{{ __("main.nodes.Binding form") }}</label>
    </div>
	...
	<div class="mb-3 form-floating">
		...
		<label>{{ __("main.nodes.Filter") }} / {{ __("main.nodes.Join") }}</label>
    </div>
	...
	<div class="mb-3 form-floating">
		...
		<label>{{ __("main.nodes.Row title node") }}</label>
    </div>
	...
	<div class="mb-3 form-floating">
		...
		<label>{{ __("main.nodes.Row description node") }}</label>
    </div>
    @endif
