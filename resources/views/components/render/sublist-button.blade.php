...
$parent = null;
if (\App\Models\HtmlList::class === $selectedNode->parent->html_type) {
...
<div class="container mb-2">
    <a class="btn btn-primary" href="javascript:void(0)" onclick="createRefresh({{ $selectedNode->parent->id  }}, 'parent_row_id={{ $fkValue->withValue->value }}', 'targetMenuContainer')"><i class="bi bi-chevron-left"></i> {{ $selectedNode->parent->name }}</a>
</div>
